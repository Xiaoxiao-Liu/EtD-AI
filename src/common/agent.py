...
#     chatbot = ChatBot("gpt-5")
#     message_history = [
#         {"role": "user", "content": "Should organised mammography screening vs. no mammography screening be used for early detection of breast cancer in women aged 70 to 74 ?"}
#     ]
#     response = chatbot.dynamic_call(message_history)
#     print(response)